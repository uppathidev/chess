  ...
  "rounded-lg border text-card-foreground transition-all duration-300",
  {
    variants: {
      variant: {
        ...
        elevated: "bg-card shadow-card hover:shadow-lg",
        glass: "bg-card/50 backdrop-blur-sm border-border/50",
        gradient: "gradient-card border-border/50",
        feature: "bg-secondary/50 border-border/30 hover:border-primary/50 hover:shadow-gold",
        pricing: "bg-card border-border hover:border-primary hover:shadow-gold",
        testimonial: "bg-secondary/30 border-border/30",
      },
    },
    defaultVariants: {
      variant: "default",
